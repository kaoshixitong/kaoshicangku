							...
							<div style="margin-top: 20px;">
								<el-row :gutter="20">
									<el-col :span="8" :offset="16">
										<el-button type="primary" @click="choice">保存</el-button>
							...
							<div style="margin-top: 20px;">
								<el-row :gutter="20">
									...
									<el-col :span="20">
										...
										>
											<template slot="append">
												<el-checkbox label="A" v-model="checkList"
													>正确答案</el-checkbox
												>
											</template>
										</el-input>
							...
							<div style="margin-top: 20px;">
								<el-row :gutter="20">
									...
									<el-col :span="20">
										...
										>
											<template slot="append">
												<el-checkbox label="B" v-model="checkList"
													>正确答案</el-checkbox
												>
											</template>
										</el-input>
							...
							<div style="margin-top: 20px;">
								<el-row :gutter="20">
									...
									<el-col :span="20">
										...
										>
											<template slot="append">
												<el-checkbox label="C" v-model="checkList"
													>正确答案</el-checkbox
												>
											</template>
										</el-input>
							...
							<div style="margin-top: 20px;">
								<el-row :gutter="20">
									...
									<el-col :span="20">
										...
										>
											<template slot="append">
												<el-checkbox label="D" v-model="checkList"
													>正确答案</el-checkbox
												>
											</template>
										</el-input>
						...
						<el-form ref="form">
							...
							<div style="margin-top: 20px;">
								<el-row :gutter="20">
									...
									<el-col :span="4">
										<el-radio v-model="judgment" label="A">对</el-radio>
										<el-radio v-model="judgment" label="B">错</el-radio>
									</el-col>
								</el-row>
							</div>
							<!-- 按钮 -->
					...
					<div class="pad-lef">
						<el-form ref="form">
							...
							<div style="margin-top: 20px;">
								<el-row :gutter="20">
									<el-col :span="8" :offset="16">
										<el-button type="primary" @click="essay">保存</el-button>
										<el-button type="reset">重置</el-button>
									</el-col>
								</el-row>
							</div>
...
export default {
	...
	methods: {
		...
		judge() {
			...
			addJudge
				.post('/exam/judge/addJudge', {
					paperId: 1,
					right: this.judgment,
					typeA: '√',
					typeB: '×',
					title: this.textareaThree,
					score: 2,
					chapterId: 1,
					single: 1,
					subjectId: 1,
		...
		essay() {
			...
			addEssay
				.post('/exam/essay/addEssay', {
					paperId: 1,
					title: this.textareaFive,
					score: 5,
					chapterId: 1,
					single: 1,
					subjectId: 1,
